...
for language in languages:
    card = TaskCard(
        ...
        templates=["templates.classification.multi_class.relation.reasoning"],
        __tags__={
    ...
    card = TaskCard(
        ...
        templates=["templates.qa.multiple_choice.with_context.reasoning"],
        __tags__={
            "annotations_creators": "Sarvam AI",
            "arxiv": "1905.10044",
            "license": "cc-by-sa-3.0",
        ...
        __description__=(
            "A multilingual version of the BoolQ (Boolean Questions) dataset, translated from English into 10 Indian languages. It is a question-answering dataset for yes/no questions containing ~12k naturally occurring questions."
            "More information can be found on the dataset page: https://huggingface.co/datasets/sarvamai/boolq-indic\n"
            "More information about the original dataset can be found on the BoolQ page: https://huggingface.co/datasets/google/boolq"
        ),
    )
